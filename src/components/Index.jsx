    ...
    return(
        <>
            ...
            <div className='bg-slate-300'>
                ...
                <div className=''>
                    <div className='z-20 pt-24  absolute'>
                        <IngredientList 
                            name={"Masala dosa"} 
                            image={masaladosa}
                    ...
                    <div className='pt-96 sm:pt-48 md:pt-48 lg:pt-0 overflow-hidden'>
                        <div className='pt-96 sm:pt-32 md:pt-28 lg:pt-0'></div>
                        <div className='pt-96 sm:pt-0 md:pt-0 lg:pt-0'></div>
                        <div className='pt-48 sm:pt-0 md:pt-0 lg:pt-0'></div>
