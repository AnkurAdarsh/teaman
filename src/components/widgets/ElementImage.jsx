    ...
    return(
        <div className='sticky'>
            ...
            <div className='p-5 grid place-items-center'>
                <label className='text-white font-Berk text-3xl pt-6 sm:pt-14 lg:pt-14 pb-5 md:text-left'>{props.contact}</label>
                <label className='text-white font-Berk text-5xl md:text-6xl pb-10 lg:pb-10  '>{props.text}</label>
